    ...
    <>
      <section className='md:px-[4vw] px-[3vw] md:py-12 py-6 mb-20'>
        ...
        <div className='flex flex-wrap gap-4 justify-between items-center'>
            <div className='md:h-[370px] h-[330px] w-[280px] shadow m-auto'  style={{ boxShadow: '10px 15px 40px 10px rgba(0, 0, 0, 0.2)' }}>
                <img src={item} alt="item" className='md:h-40 h-36 m-auto'/>
                <div className='p-4'>
            ...
            <div className='md:h-[370px] h-[330px] w-[280px] shadow m-auto' style={{ boxShadow: '10px 15px 40px 10px rgba(0, 0, 0, 0.2)' }}>
                <img src={item} alt="item" className='md:h-40 h-36 m-auto'/>
                <div className='p-4'>
                    <p className='italic md:text-base text-sm text-[#4D533C] md:mb-4 mb-8'>It really helps me fall right to sleep compared to melatonin pills.</p><br />
            ...
            <div className='md:h-[370px] h-[330px] w-[280px] shadow m-auto' style={{ boxShadow: '10px 15px 40px 10px rgba(0, 0, 0, 0.2)' }}>
                <img src={item} alt="item" className='md:h-40 h-36 m-auto'/>
                <div className='p-4'>
                    <p className='italic md:text-base text-sm text-[#4D533C] md:mb-6 mb-9'>I have been falling asleep faster and sleeping thru the night.</p><br />
